...
import com.fastchat.forchatting.databinding.ActivityGroupChatBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.backIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent goBack = new Intent(groupChatActivity.this, MainActivity.class);
        ...
        binding.ViewUserName.setText("Friends Group");
        ...
        binding.sendButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final String message = binding.sendEditText.getText().toString();
